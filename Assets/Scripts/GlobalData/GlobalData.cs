...
namespace Assets.Script.globalVar
{
    public class GlobalData
    {
        ...
        public string gameUpdateVersion = "1";
        public bool isPauseModalOn = false;
        ...
        public RoundGroupClass initializeAllRound()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                if (i == 0 || i % 5 == 0)
                {
                    ...
                    Weapon specialWeapon = new Weapon("special" + WeaponInitiationCounter, "special" + WeaponInitiationCounter,
                                        2000 * WeaponInitiationCounter, magDelay,
            ...
            MainRoundGroupClass = new RoundGroupClass(RoundGroupList, 1000, 0, GuardList, WeaponList, true);
